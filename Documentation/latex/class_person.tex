...
63     \}
64     \textcolor{keywordflow}{else} qWarning() << \textcolor{stringliteral}{"Error while trying to sort"};
65 \}
\end{DoxyCode}
...
\begin{DoxyCode}
67 \{ \hyperlink{class_person_aefba04c96d0d90ab2b220e6ad704c55a}{table} = t; \}
\end{DoxyCode}
...
\begin{DoxyCode}
74 \{
75     QStandardItemModel *model = \textcolor{keyword}{new} QStandardItemModel();
76     QStringList titols;
77     titols << \textcolor{stringliteral}{"DNI"} << \textcolor{stringliteral}{"Nom"} << \textcolor{stringliteral}{"Cognoms"} << \textcolor{stringliteral}{"Data Fi ajuda"} << \textcolor{stringliteral}{"Nº Ajudat"}
78            << \textcolor{stringliteral}{"Membres"};
79     model->setHorizontalHeaderLabels(titols);
80     
81     \hyperlink{class_person_aefba04c96d0d90ab2b220e6ad704c55a}{table}->setModel(model);
82 \}
\end{DoxyCode}
