...
\begin{DoxyCode}
37 \{
38     \hyperlink{class_dialog}{Dialog} *d = \textcolor{keyword}{new} \hyperlink{class_dialog}{Dialog};
39     d->setAttribute(Qt::WA\_DeleteOnClose);
40     d->setWindowTitle(\textcolor{stringliteral}{"Associació Hesed - Inserir"});
41     d->open();
42     \hyperlink{structinfo}{info}.addInfo();
43 \}
\end{DoxyCode}
