...
struct qt_meta_stringdata_InsDialog_t {
    QByteArrayData data[3];
    char stringdata[19];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_InsDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_InsDialog_t qt_meta_stringdata_InsDialog = {
    {
QT_MOC_LITERAL(0, 0, 9),
QT_MOC_LITERAL(1, 10, 7),
QT_MOC_LITERAL(2, 18, 0)
    },
    "InsDialog\0addHelp\0"
};
...
const QMetaObject InsDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_InsDialog.data,
      qt_meta_data_InsDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_InsDialog.stringdata))
